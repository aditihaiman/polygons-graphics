...
def add_box( polygons, x, y, z, width, height, depth ):
    ...
    #front
    add_polygon(polygons, x, y, z, x, y1, z, x1, y, z) #left
    ...
    for lat in range(lat_start, lat_stop):
        for longt in range(longt_start, longt_stop):
            ...
            if(lat != steps-1):
                ...
                points[t+N+1][0], points[t+N+1][1], points[t+N+1][2])
...
def add_torus(polygons, cx, cy, cz, r0, r1, steps ):
    ...
    for lat in range(lat_start, lat_stop):
        for longt in range(longt_start, longt_stop):
            ...
            if(lat != N-1):
                if(longt != N-1):
                    add_polygon(polygons, points[t][0], points[t][1], points[t][2], points[t+N][0], points[t+N][1], points[t+N][2], points[t+1+N][0], points[t+1+N][1], points[t+1+N][2])
                    
                    add_polygon(polygons, points[t][0], points[t][1], points[t][2],
                        points[t+1+N][0], points[t+1+N][1], points[t+1+N][2],
                        points[t+1][0], points[t+1][1], points[t+1][2])
                else:
                    add_polygon(polygons, points[t][0], points[t][1], points[t][2], points[t+N][0], points[t+N][1], points[t+N][2], points[t+1][0], points[t+1][1], points[t+1][2])
                ...
                if(longt != N-1):
                    add_polygon(polygons, points[t][0], points[t][1], points[t][2], points[t%N][0], points[t%N][1], points[t%N][2], points[t%N+1][0], points[t%N+1][1], points[t%N+1][2])
                    
                    add_polygon(polygons, points[t][0], points[t][1], points[t][2],
                        points[t%N+1][0], points[t%N+1][1], points[t%N+1][2],
                        points[t+1][0], points[t+1][1], points[t+1][2])
                else:
                    add_polygon(polygons, points[t][0], points[t][1], points[t][2], points[t%N][0], points[t%N][1], points[t%N][2], points[t%N+1-N][0], points[t%N+1-N][1], points[t%N+1-N][2])
                    
                    add_polygon(polygons, points[t][0], points[t][1], points[t][2],
                        points[t%N+1-N][0], points[t%N+1-N][1], points[t%N+1-N][2],
                        points[t+1-N][0], points[t+1-N][1], points[t+1-N][2])
